...
-- Streets (roads)
-- Each road has two or more coordinates (points), and a width
-- Example for the first road (N-S long):
...
-- Add more INSERTs for each road segment as needed, following the above pattern.
-- For roads with more than two points, you may need to split into multiple street segments or adjust the model accordingly.

-- Example for a diagonal road:
...
-- Continue for all roads from your frontend definition...
