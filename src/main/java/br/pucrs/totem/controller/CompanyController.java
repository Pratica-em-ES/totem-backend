...
public class CompanyController {
    ...
    public ResponseEntity<BuildingCompany> addBuildingToCompany(
        ...
        BuildingCompany buildingCompany = companyService.addBuildingToCompany(id, buildingId, floors);
    ...
    public ResponseEntity<BuildingCompany> updateCompanyBuilding(
        ...
        BuildingCompany updatedBuildingCompany = companyService.updateCompanyBuilding(buildingCompanyId, floors);
