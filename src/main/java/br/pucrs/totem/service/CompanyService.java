...
public class CompanyService {
    ...
    public BuildingCompany addBuildingToCompany(Long companyId, Long buildingId, String floors) {
        ...
        if (company.isPresent() && building.isPresent()) {
            ...
            buildingCompany.setFloors(floors);
            return buildingCompanyRepository.save(buildingCompany);
        }
        return null;
    }

    public BuildingCompany updateCompanyBuilding(Long buildingCompanyId, String floors) {
